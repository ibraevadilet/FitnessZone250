...
class CustomButtonFitessZone extends StatelessWidget {
  const CustomButtonFitessZone({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return CupertinoButton(
      ...
      child: Container(
        ...
        child: isLoading
            ? const AppIndicatorFitessZone(color: Colors.white)
            : child ??
                Text(
                  text!,
                  textAlign: TextAlign.center,
                  style: textStyle ??
                      AppTextStylesFitnessZone.s17W600(
